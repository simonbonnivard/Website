...
export function initSite() {
  ...
  function initViewportFocus() {
    ...
    const groups = [
      [...document.querySelectorAll(".problems__head, .problems__card")],
      [...document.querySelectorAll(".solution__head, .solution__card")],
      [...document.querySelectorAll(".mecanisme__head, .mecanisme__card")],
